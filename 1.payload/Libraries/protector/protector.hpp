...
namespace protector {
	...
	{
		VMProtectBeginUltra(OBFUSCATED("Detected Func"));

		throw OBFUSCATED("continue");
		exit(0);
	...
	void exe_detect()
	{
		VMProtectBeginUltra(OBFUSCATED("EXE Detect Function"));
	...
	void title_detect()
	{
		VMProtectBeginUltra(OBFUSCATED("TitleDetect Function"));
	...
	void driver_detect()
	{
		VMProtectBeginUltra(OBFUSCATED("Driver Detect"));
	...
	{
		VMProtectBeginUltra(OBFUSCATED("EraseHeaderFromMemory Function"));
	...
	{
		VMProtectBeginUltra(OBFUSCATED("ProcessDebugFlags Function"));
